...
$(function(){var e=$(".page-container"),r=$(".bg-video"),t=r.get(0),i=function(r){e.attr("data-state",r),setTimeout(function(){e.attr("data-state","")},200)},n=[];t.addEventListener("timeupdate",function(){console.log(t.currentTime),!n[0]&&t.currentTime>.25&&t.currentTime<.5?(n[0]=1,i(2)):!n[1]&&t.currentTime>1.45&&t.currentTime<1.8?(n[1]=1,i(1)):!n[2]&&t.currentTime>1.9&&t.currentTime<2.2?(n[2]=1,i(2)):!n[3]&&t.currentTime>2.6&&t.currentTime<3?(n[3]=1,i(1)):!n[4]&&t.currentTime>3.15&&t.currentTime<3.45?(n[4]=1,i(2)):!n[5]&&t.currentTime>4.6&&t.currentTime<4.9?(n[5]=1,i(2)):!n[6]&&t.currentTime>4.9&&t.currentTime<5.15?(n[6]=1,i(1)):!n[7]&&t.currentTime>5.55&&t.currentTime<5.85?(n[7]=1,i(1)):!n[8]&&t.currentTime>6.05&&t.currentTime<6.37?(n[8]=1,i(2)):!n[9]&&t.currentTime>7.25&&t.currentTime<7.6?(n[9]=1,i(1)):!n[10]&&t.currentTime>8&&t.currentTime<8.35?(n[10]=1,i(1)):!n[11]&&t.currentTime>8.7&&t.currentTime<9.03?(n[11]=1,i(1)):!n[12]&&t.currentTime>9.03&&t.currentTime<9.3?(n[12]=1,i(2)):!n[13]&&t.currentTime>9.5&&t.currentTime<9.76?(n[13]=1,i(0)):!n[14]&&t.currentTime>9.94&&t.currentTime<10.24?(n[14]=1,i(0)):!n[15]&&t.currentTime>10.25&&t.currentTime<10.5?(n[15]=1,i(0)):!n[16]&&t.currentTime>11.2&&t.currentTime<11.5?(n[16]=1,i(0)):17==n.length&&(n=[])},!1),device.mobile()||device.tablet()||screenJS.isPortrait()&&device.desktop()||(t.playbackRate=.7,t.play())});
